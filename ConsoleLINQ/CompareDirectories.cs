...
internal class CompareDirectoriesTest
{
    ...
    {
        string pathA = """C:\Program Files\dotnet\sdk\9.0.100""";
        string pathB = """C:\Program Files\dotnet\sdk\9.0.101""";

        DirectoryInfo dir1 = new(pathA);
        DirectoryInfo dir2 = new(pathB);
